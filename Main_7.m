...
%w = [0, pi/2, 0, pi/2, 0,pi/2, 0, pi/2, 0, pi/2]; % Velocidad angular de referencia (rad/s)x  

%u = 2*ones(1,N); % Velocidad lineal de referencia (m/s)
%u = [0,    2,  0,    2, 0,    2.5,   0,   2, 2];
%w = [3.49, 0, -3.49, 0, 3.49, 0,  4.8, 0, 2]; % Velocidad angular de referencia (rad/s)x 

u = [0,    2,  0,    2, 0,    2.5,   0,   2, 2];
w = [3.49, 0, -3.49, 0, 3.49, 0,  4.8, 0, 2]; %
...
axis([-10 10 -10 10 0 2]); % Ingresar limites minimos y maximos en los ejes x y z [minX maxX minY maxY minZ maxZ]
